...
def browser():
    ...
    test_pagination_SP(driver)
    driver.quit()


def test_pagination_SP(driver):
    """
    ID: TC-SP-10
    Title: Pagination checklist - Search Player
    Description: Check every pagination function in Search Player screen
    ...
    test_result(status, result, "Player List", "TC-SP-10")
